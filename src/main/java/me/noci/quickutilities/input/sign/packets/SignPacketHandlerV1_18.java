...
public class SignPacketHandlerV1_18 implements SignPacketHandler {
    ...
    public void openEditor(Player player, BlockPosition position, SignData signData) {
        ...
        tileEntityData.getBlockEntityTypeModifier().write(0, WrappedRegistrable.blockEntityType("sign"));
